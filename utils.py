...
def connect_database():
    try:
        ...
        connection_string = f'DRIVER=ODBC Driver 17 for SQL Server;SERVER={MYSQL_HOST};DATABASE={MYSQL_DATABASE};UID={MYSQL_USER};TrustServerCertificate=yes;Encrypt=no;'
